...
autoload :LaddersSearcher, 'lib/models/ladders_searcher'
autoload :UserJobSearcher, 'lib/models/user_job_searcher'
autoload :AbstractModel, 'lib/models/abstract_model'
autoload :InvalidObjectException, 'lib/models/invalid_object_exception'
